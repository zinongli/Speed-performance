...
cd('C:\Users\labadmin\Documents\QingjieExp');
            ...
            for frame = 1: framerate * (story(3)+2) 
                ...
                if frame <= framerate * (story(3)+2)
                    ...
                    if frame >= framerate * story(1)
                        ...
                        Screen('FillRect', displayInfo.window, [0 0 1], [displayInfo.xCenter - percent_score * scorebar_length,300,displayInfo.xCenter + percent_score * scorebar_length,600]);
